...
class LivePredictorV2:
    ...
    def __init__(self, db_path=None):
        import os
        if db_path is None:
            # Toujours chercher la base relativement au dossier du script
...
def demo_paderborn_elversberg():
    """Prédiction live réelle pour Paderborn vs Elversberg (germany2) avec stats live extraites."""
    predictor = LivePredictorV2()
    # Stats live extraites précédemment (minute 53)
    match = LiveMatchContext(
        ...
        country="Germany",
        league="germany2",
        possession_home=49.0,
        possession_away=51.0,
        corners_home=3,
        corners_away=6,
        shots_home=6,
        shots_away=7,
        ...
        shots_inside_box_away=6,
        shots_outside_box_home=2,
        shots_outside_box_away=1,
        attacks_home=42,
        attacks_away=56,
